...
use Yii;
use customer\jobs\RegisterEmail;
use customer\jobs\RegisterPhone;
 ...
 *  
 */
class SendRegisterCodeForm extends Model
{
    ...
    public function validateUsername( $attribute )
    {
        ...
        $savedUsername = RegisterForm::getSavedUsername();
