...
$this->title = Yii::t('app', 'Manage navs');
?>


<div class="d-flex">
    <div class="my-3">
        <div><a id="add_root_nav" class="btn btn-sm btn-molv" href="#">新增主导航菜单</a></div>
...
<script>
    ...
    $('#add_root_nav').on('click', function( e ) {
        stopEvent(e);
        var inst = $('#nav_container').jstree(true);
